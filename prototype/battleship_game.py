...
def main():
    ...
    # Insert 0 in every position of the 3D array ocean_grid[row][column][val]
    for row in range(10): 
        ocean_grid.append([])
    ...
    # Insert 0 in every position of the 3D array screen_grid[row][column][values]
    for row in range(10): 
        screen_grid.append([])
        for column in range(10):
    ...
    # Insert 0 in every position of the 2D array ship_info[order][details]
    ...
    # Place Ships in descending order of size (First Battleship)
    while placed != 5: 
